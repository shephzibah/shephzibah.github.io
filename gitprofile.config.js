...
const config = {
  ...
  social: {
    linkedin: '/hephzibah-saidu-30b627147/',
    twitter: '',
  ...
  resume: {
    fileUrl:
      'https://github.com/shephzibah/shephzibah.github.io/blob/main/Software_Engineer_HS.pdf', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Java', 
    'Python', 
